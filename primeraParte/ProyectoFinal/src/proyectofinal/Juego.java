            ...
            if(jugadores.size()>0){
              for(int i= 0;i<jugadores.size()-1;i++){
                if(jugador.equals(jugadores.get(i))){
                  ...
                  controller.escribirObjeto("jugadores.dat", jugadores);
                  Object objJugador [] = {jugador.getNombre(),jugador.getApellido(),jugador.getCedula(),jugador.getLogin()};
                  model = (DefaultTableModel) tblListaJugadores.getModel();
                  model.removeRow(jugadores.size());
                  llenarCombo();
